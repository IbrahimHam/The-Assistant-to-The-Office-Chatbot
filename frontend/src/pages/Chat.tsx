...
const Chat = () => {
  ...
  const characters: Character[] = [
    "Michael", "Jim", "Pam", "Dwight", "Angela", 
    "Oscar", "Kevin", "Stanley", "Creed", "Toby"
  ];
  ...
  const toggleRoster = () => {
    ...
    const toggleSound = new Audio('https://assets.mixkit.co/sfx/preview/mixkit-unlock-game-notification-253.mp3');
  ...
  return (
    <div className="min-h-screen bg-officeBackground flex flex-col overflow-hidden">
      {/* Header and character roster */}
      <div className="bg-dundies p-4 pixel-border">
        ...
        <div className="max-w-3xl mx-auto flex items-center">
          ...
          <div className="hidden sm:block mr-3">
            <div className="w-12 h-12 pixel-border overflow-hidden bg-black">
              <img 
                src={`https://i.ibb.co/${
                  currentCharacter === "Michael" ? "YQKWTkC/michael" :
                  currentCharacter === "Jim" ? "cY25vBN/jim" :
                  currentCharacter === "Pam" ? "ZH1tygH/pam" :
                  currentCharacter === "Dwight" ? "kS5Z72v/dwight" :
                  currentCharacter === "Angela" ? "VSxFvf6/angela" :
                  currentCharacter === "Oscar" ? "NpDjyC1/oscar" :
                  currentCharacter === "Kevin" ? "PGM9QnW/kevin" :
                  currentCharacter === "Stanley" ? "G5T4H3W/stanley" :
                  currentCharacter === "Creed" ? "DbKH3vY/creed" :
                  "dkKL9Vf/toby"
                }.png`} 
